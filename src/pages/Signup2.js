...
function Signup2() {
  ...
  const isPasswordValid = (password) => {
    // The regular expression checks whether the password has at least 8 characters, letters and numbers
    const hasMinimumLength = password.length >= 8;
    const hasLetterAndNumber = /[a-zA-Z]/.test(password) && /\d/.test(password);
    return hasMinimumLength && hasLetterAndNumber;;
  };
  ...
  const handleSignUp = async (e) => {
    ...
    if (!isPasswordValid(password)) {
      alert('The password need to be at least 8 characters, letters and numbers.');
      return;
    }
    try {
        ...
        <div className='home-container'>
          <div className="row align-items-start first-section">
              <div className='form-component'>
                ...
                <div className='row'>
                  <div className='col'>
                    <input type="text" className="form-control" id="first_name" placeholder="First name" value={firstname} onChange={(e) => setFirstname(e.target.value)} required/>
                  </div>
                  <div className='col'>
                    <input type="text" className="form-control" id="last_name" placeholder="Last name" value={lastname} onChange={(e) => setLastname(e.target.value)} required/>
                  </div>
                </div>      
                ...
                <div className='row forget_login_container_bottom'>
                  <div className='col'>
                    ...
                    <div className='form-component-social-button'>
                      <a href="/login">
                        <button className="btn btn-primary btn-google" type="submit">Sign in.</button>
                      </a>
                    </div>
                  </div>
                </div>
